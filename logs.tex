	...
	\begin{questions}
	\question Descreva os tipos de logs. 

	\begin{solutionbox}{2.4in} \end{solutionbox}

	\question O que é telemetria em software?
	\begin{solutionbox}{1.5in} 		
		\end{solutionbox}

	\question Elucide o uso de \textit{Rsyslog} e explique qual porta padrão
	\begin{solutionbox}{1.95in} 		
		\end{solutionbox}
	\question Qual é o diretório que os logs ficam salvos no Debian/Ubuntu?
	\begin{solutionbox}{3in} 	
		\end{solutionbox}
	\question O que é observabilidade em computação?
	\begin{solutionbox}{3in} 	
		\end{solutionbox}
