...
\begin{document}
	...
	\begin{frame}{Software \& Sociedade}
		...
		\begin{block}{Bem informacional sistêmico}
			O software deve ser compreendido como \textb{bem informacional sistêmico}\footnote{Conceito jurídico e teórico que entende a informação
			 não como um elemento isolado, mas como um bem de circulação, uso compartilhado e estrutura organizacional que se insere em 
			 	sistemas sociais, econômicos e tecnológicos}, situado na interseção entre criação intelectual, funcionalidade 
