...
\PaperTitle{Using logs to support programming education} % Article title

\Authors{Gilmar Gomes do Nascimento\textsuperscript{1}*, James Smith\textsuperscript{2}} % Authors
...
\Keywords{programming education, log, telemetry} 
...
O ensino de programação é uma atividade multidisciplinar que demanda 
uma práxis pedagógica apurada, que integra teoria e prática em sala de 
aula. O acompanhamento acadêmico costuma ser lista de frequência e 
atividades realizadas, além das notas; contudo os estudantes seguem uma trilha, contudo os rastros deixados no aprendizado raramente são coletados de forma qualiquantitativa. 
