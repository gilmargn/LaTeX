	...
	\begin{document}
		...
		\end{frame}
% ============================================================
% PARTE 1 – FUNDAMENTAÇÃO TEÓRICA (O QUE É PROXY?)
% ============================================================

\begin{frame}{Revisão: O que é Proxy?}
	\begin{block}{Definição}
		Atua como um intermediário (``Man-in-the-Middle") entre o navegador e o servidor da aplicação web.
	\end{block}
	\begin{block}{Interceptação}
		Permite interceptar, visualizar e modificar requisições e respostas HTTPs em tempo real.
	\end{block}
\end{frame}
\begin{frame}
	\begin{block}{Hoje vamos aprofundar...}
		\begin{itemize}
			\item Tipos de proxy e seus usos
			\item ZAP como proxy de segurança (prática)
			\item Squid como proxy de infraestrutura (teoria + prática)
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}{Definição de Proxy}
			...
			\begin{figure}
				\includegraphics[scale=.5]{proxy-example}
		...
		\begin{frame}[allowframebreaks]{Servidor de Proxy}
			...
			\begin{figure}
				\includegraphics[scale=0.45]{settings-proxy}
			\end{figure}		
		\end{frame}
...
% ============================================================
% PARTE 2 – PROXY PARA SEGURANÇA (OWASP ZAP)
% ============================================================
		...
		\begin{frame}{Python}
			...
			\begin{figure}
				\includegraphics[scale=1]{python-server.png}
			\end{figure}			
		\end{frame}
		...
		\begin{figure}
			\includegraphics[scale=.4]{firefox-proxy}
		\end{figure}	
		\end{frame}
		...
		\begin{frame}{Intercepte a requisição}
			\begin{figure}
				\includegraphics[scale=0.35]{zap-manual-explorer}
			\end{figure}
		\end{frame}
		...
		\begin{frame}{Encontre a bandeira}
			\begin{figure}
				\includegraphics[scale=0.5]{zap-bandeira}
			\end{figure}
			
		\end{frame}

% ============================================================
% PARTE 3 – PROXY PARA INFRAESTRUTURA (SQUID CACHE)
% ============================================================
...
%				 and control certain web content types where dictated by technical or economic reasons.				
%			\end{block}
%			\end{frame}
			
		\begin{frame}{Escalar a aplicação web}
...
% ============================================================
% PARTE 4 – HANDS-ON SQUID (NA KALI LINUX)
% ============================================================
...
\begin{frame}[allowframebreaks]{Referências Bibliográficas}
	\begin{thebibliography}{9}
		...
		Disponível em: \url{https://pt.wikipedia.org/w/index.php?title=Proxy&oldid=68693766}. Acesso em: 24 de agosto de 2026.
	\end{thebibliography}
\end{frame}		
