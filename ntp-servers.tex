...
%\input{shark}
\begin{questions}
\question Escreva os dois tipos de comandos para o gerenciamento de serviços (status, start, stop, restart). Use como exemplo o serviço \textt{chrony}
...
\begin{solutionbox}{4in} 		
	\end{solutionbox}
\question Pode se utilizar dois serviços NTP ao mesmo tempo e na mesma máquina? 
\begin{solutionbox}{4in} 		
	\end{solutionbox}
