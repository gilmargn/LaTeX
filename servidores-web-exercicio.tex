	...
	\newcommand{\examnum}{Exercício - Servidores Web} \newcommand{\examdate}{$\today$}
	...
	\question Elucide a diferença entre os servidores web e servidores de aplicação.
	\begin{solutionbox}{2in}
	\end{solutionbox}

	\question Cite exemplos de servidores de aplicação web.
	...
	\question Detalhe o que é XAMPP, WAMP, LAMP.
	\begin{solutionbox}{3in}
	\end{solutionbox}
\end{questions}
	\end{document}
